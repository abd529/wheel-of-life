...
import 'package:com.example.wheel_of_life/Authentication/login_screen.dart';
import 'package:com.example.wheel_of_life/Screens/report.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "The current language is ${AppLocalizations.of(context)!.language}",
                style:
              ...
              ElevatedButton(
                  onPressed: () async {
                    Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => TranslatedVideo(videoId: videoId),
                    ));
                  },
