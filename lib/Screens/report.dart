              ...
              Padding(
                ...
                child: ElevatedButton(onPressed: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => PDFScreen(
                    ...
                    healthQ5:healthQ5,
                    healthQ6:healthQ6,
                    healthAvg: double.parse(healthAvg.toStringAsFixed(1)),
                    ...
                    personalAvg:  double.parse(personalAvg.toStringAsFixed(1)),
                    famQ1:famQ2,
                    famQ2:famQ2,
                    famQ3:famQ3,
                    famQ4:famQ4,
                    ...
                    famQ6:famQ6,
                    famQ7:famQ7,
                    famAvg: double.parse(famAvg.toStringAsFixed(1)),
                    homeQ1:homeQ1,
                    homeQ2:homeQ2,
                    homeQ3:homeQ3,
                    homeQ4:homeQ4,
                    homeQ5:homeQ5,
                    homeQ6:homeQ6,
                    homeAvg: double.parse(homeAvg.toStringAsFixed(1)),
                    freeQ1:freeQ1,
                    freeQ2:freeQ2,
                    freeQ3:freeQ3,
                    freeQ4:freeQ4,
                    freeQ5:freeQ5,
                    freeQ6:freeQ6,
                    freeAvg: double.parse(freeAvg.toStringAsFixed(1)),
                    loveQ1:loveQ1,
                    loveQ2:loveQ2,
                    loveQ3:loveQ3,
                    loveQ4:loveQ4,
                    ...
                    loveQ7:loveQ7,
                    loveQ8:loveQ8,
                    loveAvg:  double.parse(loveAvg.toStringAsFixed(1)),
                    workQ1: workQ1,
                    workQ2:workQ2,
                    workQ3:workQ3,
                    workQ4:workQ4,
                    ...
                    workQ7:workQ7,
                    workQ8:workQ8,
                    workAvg: double.parse(workAvg.toStringAsFixed(1)),
                    moneyQ1: moneyQ1,
                    moneyQ2:moneyQ2,
                    moneyQ3:moneyQ3,
                    moneyQ4:moneyQ4,
                    ...
                    moneyQ7:moneyQ7,
                    moneyQ8: moneyQ8,
                    moneyAvg: double.parse(moneyAvg.toStringAsFixed(1)),
                    ),
                    ));
                  }, 
